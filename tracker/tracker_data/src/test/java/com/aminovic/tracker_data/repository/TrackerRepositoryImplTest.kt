...
import com.aminovic.tracker_data.remote.malformedFoodResponse
import com.aminovic.tracker_data.remote.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    fun `Search food, valid response, return results`() = runBlocking {
        ...
        val result = repository.searchFood("banana", page = 1, 40)
